...
#define USE_E1_AS_Z2 // redefine E1 steper driver as Z2
#define REMAP_HEATER_PINS // remap fan pins as hater pins for external mosfet use (neater wiring)
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp  47.78
  #define DEFAULT_bedKi   2.35
  #define DEFAULT_bedKd 647.31
#else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.60, 79.72, 1578.68, 95.10 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 8, 45 }
 ...
 */
#define Z_MIN_PROBE_PIN SERVO0_PIN
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -25, 10, -2.150 }
 ...
 */
#define EVENT_GCODE_AFTER_G29 "G1 Z15.0 F2000"
